...
public class NetworkParameters implements Serializable {
     ...
     */
    public static final byte[] SATOSHI_KEY = Hex.decode("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f");
    ...
    private NetworkParameters(int type) {
        ...
        if (type == 0) {
            ...
            genesisBlock.setTime(1390747675);
            ...
            checkState(genesisHash.equals("0x00000c7c73d8ce604178dae13f0fc6ec0be3275614366d44b1b4b5c6e238c60c"),
                    genesisHash);
            ...
            checkpoints.put(0, new Sha256Hash("0x60427defa713035a27542cb2b955b0001e01878f4828855b1fb137d3560279aa"));
            ...
            subsidyDecreaseBlockCount = 241920;
            String genesisHash = genesisBlock.getHashAsString();
            checkState(genesisHash.equals("0x000007717e2e2df52a9ff29b0771901c9c12f5cbb4914cdf0c8047b459bb21d8"),
                    genesisHash);
        } else if (type == 2) {
            id = ID_TESTNET;
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            byte[] bytes = Hex.decode
                    ("04f09702847840aaf195de8442ebecedf5b095cdbb9bc716bda9110971b28a49e0ead8564ff0db22209e0374782c093bb899692d524e9d6a6956e7c5ecbcd68284");
    ...
    public static final int TARGET_TIMESPAN = 8 * 60;  // 2 weeks per difficulty cycle, on average.
    public static final int TARGET_SPACING = 120;  // 10 minutes per block.
